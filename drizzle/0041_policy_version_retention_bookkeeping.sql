-- protect_ready_policy_version liess auf einer fertig geparsten Fassung nur zwei
-- Uebergaenge zu: die Loeschmarkierung und die Uebergabe vom Entwurf an die
-- Organisation. Drei legitime Schreibpfade fielen dadurch durch — der Abschluss
-- einer Analyse und beide Aufbewahrungs-Jobs. Die uebrigen Zweige der Funktion
-- bleiben unveraendert; ergaenzt wird ausschliesslich die Aufbewahrungsbuchhaltung.
