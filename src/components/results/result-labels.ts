...
export async function loadAnalysisResultLabels(): Promise<AnalysisResultLabels> {
  ...
  return {
    ...
    conclusion: {
      finding: t("results.conclusion.finding"),
      impact: t("results.conclusion.impact"),
      gap: t("results.conclusion.gap"),
      actions: t("results.conclusion.actions"),
      actionsProgress: t.raw("results.conclusion.actionsProgress") as string,
      empty: t("results.conclusion.empty"),
    },
